...
(function() {
    ...
    var defaultOptions = {
        ...
        DataSeries: {
            ...
            indexLabelFontFamily: "Open Sans", // fx: Arial Verdana "Courier New" Serif 
    ...
    var themes = {
        "theme1": {
            ...
            Title: {
                fontFamily: isCanvasSupported ? "Open Sans" : "calibri",
                fontSize: 33,
                fontColor: "#3A3A3A",
                fontWeight: "bold",
                verticalAlign: "top",
            ...
            Axis: {
                ...
                titleFontFamily: isCanvasSupported ? "Open Sans, sans-serif" : "calibri",
                //titleFontWeight: "bold",

                //labelFontFamily: "Times New Roman, Times, serif",
                labelFontFamily: isCanvasSupported ? "Open Sans, sans-serif" : "calibri",
            ...
            Legend: {
                ...
                fontFamily: isCanvasSupported ? "Open Sans" : "Open Sans"
            },
            DataSeries: {
                //bevelEnabled: true,
                indexLabelFontColor: "grey",
                //indexLabelFontFamily: "Trebuchet MS, monospace, Courier New, Courier",
                indexLabelFontFamily: isCanvasSupported ? "Open Sans, sans-serif" : "calibri",
    ...
    Chart.prototype._updateOptions = function() {
        ...
        if (typeof(defaultOptions.Chart.creditHref) === "undefined") {
            this.creditHref = "Soft Agua";
            this.creditText = "Soft Agua";
        } else {
    ...
    Chart.prototype.validateRegion = function(px1, py1, px2, py2, keepAxisIndependent) {
        ...
        return {
            isValid: isValid,
            axesWithValidRange: axesWithValidRange,
        ...
        for (var i = 0; i < points.length; i++) {
            ...
            if (points[pointIndex].x > points[i1].x && drv1.x > 0 || points[pointIndex].x < points[i1].x && drv1.x < 0)
                ...
                var cp1 = {
                    ...
                    y: points[pointIndex].y + drv1.y / 9
                }
            ...
            if (points[pointIndex].x > points[i1].x && drv2.x > 0 || points[pointIndex].x < points[i1].x && drv2.x < 0)
                ...
                var cp2 = {
                    x: points[pointIndex].x,
                    y: points[pointIndex].y - drv2.y / 9
                }
    ...
    Axis.setLayoutAndRender = function(axisX, axisY, axisY2, axisPlacement, freeSpace) {
        ...
        var i = 0;
        var firstLabelWidthX = 0,
            lastLabelWidthX = 0,
            firstLabelWidthY, lastLabelWidthY, firstLabelWidthY2, lastLabelWidthY2, firstLabelPosition, lastLabelPosition, lastLabelWidthOutside = 0,
            firstLabelOutside = 0;
